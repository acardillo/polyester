...
class TestVectorStore:
    ...
    def test_init_with_custom_model(self):
        ...
        store = VectorStore(collection_name="test2", model_name="all-MiniLM-L6-v2")
    ...
    def sample_documents(self):
        ...
        return [
            Document(
                ...
                relationships=[
                    Relationship(
                        source_id="json.load", target_id="json.loads", relationship_type="calls"
                    )
                ],
            ),
            Document(
        ...
        docs = [
            Document(
                ...
                relationships=[
                    ...
                    Relationship(
                        source_id="class1", target_id="class3", relationship_type="inherits"
                    ),
                ],
            ),
    ...
    def test_circular_relationships(self, graph_store):
        ...
        docs = [
            Document(
                ...
                metadata={},
                relationships=[
                    Relationship(source_id="func1", target_id="func2", relationship_type="calls")
                ],
            ),
            Document(
                id="func2",
                ...
                metadata={},
                relationships=[
                    Relationship(source_id="func2", target_id="func1", relationship_type="calls")
                ],
            ),
        ]
...
class TestBM25Store:
    ...
    def test_documents_with_special_characters(self, bm25_store):
        ...
        docs = [
            Document(
                id="doc1", content="This has special chars: @#$% and numbers 123", metadata={}
            ),
            Document(id="doc2", content="Normal text without special characters", metadata={}),
        ]
